0. はじめに
C#.Net及びWPFを用いた電卓アプリケーションです。
メモリ機能とキーボード入力機能は実装済です。
※メモリ機能につきましては、
　アプリケーションを終了した際に、保存されているデータは消去されます。
...
CPU             Core i7
メモリ          8GB
エディタ        Microsoft Visual Studio Community 2026
.Net Framework  4.8.09221
SDK             dotnet-sdk-8.0.416-win-x64
